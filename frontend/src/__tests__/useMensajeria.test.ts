...
describe('useMessaging', () => {
  ...
  it('should load conversations on mount', async () => {
    ...
    vi.mocked(apiClient.get).mockResolvedValue([{ id: 1, otherParticipant: { userId: '2', userFirstName: 'Ana', userLastName: 'Lopez', userRole: 'professor' }, participants: [], lastMessage: null, unreadCount: 0 }]);
