...
app.get('/', async (c) => {
  try {
    const response = await fetch(`${CURSOS_SERVICE}/cursos`);
...
app.get('/:id', async (c) => {
  ...
  try {
    const response = await fetch(`${CURSOS_SERVICE}/cursos/${id}`);
    const data = await response.json();
...
app.get('/asignaturas', async (c) => {
  try {
    const response = await fetch(`${CURSOS_SERVICE}/cursos/asignaturas`);
    const data = await response.json();
    return c.json(data);
  } catch (error) {
...
app.put('/asignaturas/:id', async (c) => {
  ...
  try {
    const body = await c.req.json();
    const response = await fetch(`${CURSOS_SERVICE}/cursos/asignaturas/${id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(body),
    });
...
app.get('/:cursoId/materias', async (c) => {
  ...
  try {
    const response = await fetch(`${CURSOS_SERVICE}/cursos/${cursoId}/materias`);
    const data = await response.json();
    return c.json(data);
  } catch (error) {
...
app.post('/asignar-materia', async (c) => {
  try {
    ...
    const response = await fetch(`${CURSOS_SERVICE}/cursos/asignar-materia`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(parsed.data),
    });
...
app.put('/asignar-materia/:id', async (c) => {
  ...
  try {
    const body = await c.req.json();
    const response = await fetch(`${CURSOS_SERVICE}/cursos/asignar-materia/${id}`, {
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify(body),
    });
